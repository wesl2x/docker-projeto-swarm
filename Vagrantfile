...
machines = {
  ...
  "node04" => {"memory" => "1024", "cpu" => "1", "ip" => "104", "image" => "bento/ubuntu-22.04"},
  "node05" => {"memory" => "1024", "cpu" => "1", "ip" => "105", "image" => "bento/ubuntu-22.04"},
  "node06" => {"memory" => "1024", "cpu" => "1", "ip" => "106", "image" => "bento/ubuntu-22.04"}
}
